...
namespace FlexibleInventorySystem_Practice.Models
{
        ...
        public class GroceryProduct : Product
        {
            ...
            {
                // TODO: Implement
                return $"Name: {Name}, Expiry: {ExpiryDate.ToShortDateString()}, Perishable: {IsPerishable}, Weight: {Weight}kg, Storage: {StorageTemperature}";
            }
            /// <summary>
            ...
            public override decimal CalculateValue()
            {
                ...
                {
                    return baseValue * 0.8m; // 20% discount
                }
                return baseValue;
                // throw new NotImplementedException();
            }
